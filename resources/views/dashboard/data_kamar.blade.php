      ...
      <div class="container-fluid">
        <nav class="navbar--sub navbar-expand navbar-light bg-gray mt-3 mb-4 shadow">
          ...
          <form class="my-2 my-lg-0 pt-1">
            ...
            <i class="far fa-arrow-alt-circle-right"></i>
            <a href="#" class="pl-2">Data Kamar</a>
          </form>
        </nav>
      </div>
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="form-group w-25">
              <label for="nis">Kapasitas</label>
              <input type="text" class="form-control" id="nis" placeholder="contoh: 100">
            </div>
          </form>
        </div>
        ...
        <div class="modal-body">
          <form>
            ...
            <div class="form-group w-25">
              ...
              <input type="text" class="form-control" id="kapasitas" placeholder="contoh: 100">
            </div>
          </form>
        </div>
        <div class="modal-footer">
